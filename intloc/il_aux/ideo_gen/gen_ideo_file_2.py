...
with open(svg, "w") as svg:
    ...
    for i in range(n):
        ...
        chrom = i
        p_arm = random.randint(20,200)
        q_arm = 2*p_arm + random.randint(10,200)
        chr_block = (
        f"    <clipPath id=\"ideo_{clip_path_id}\">"
        f"      <path id=\"ideo_{path_id}\" d=\"M0,5.05 C0,2.5 3,0 6,0 C9,0 12,2.5 12,5 L12,{p_arm} C12,{p_arm+ 2} 9,{p_arm + 5} 6 {p_arm + 5} C3,{p_arm + 5} 0,{p_arm + 2} 0,{p_arm} Z M0,{p_arm + 10} C0,{p_arm + 7} 3,{p_arm + 5} 6,{p_arm + 5} C9,{p_arm + 5} 12,{p_arm + 7} 12,{p_arm + 10} L12,{q_arm} C12,{q_arm + 3} 9,{q_arm + 5} 6 {q_arm + 5} C3,{q_arm + 5} 0,{q_arm + 3} 0,{q_arm} Z\" fill=\"rgb(240,240,255)\" stroke=\"rgb(0,0,0)\" stroke-width=\"1.000px\"/>\n"
        f"    </clipPath>\n"  
        ...
        f"                <rect fill=\"url(#arm)\" height=\"{p_arm + q_arm}\" stroke=\"none\" width=\"12\" x=\"0\" y=\"0\"/>\n"
        f"                <rect fill=\"url(#acen)\" height=\"20\" stroke=\"none\" width=\"12\" x=\"0\" y=\"{p_arm - 5}\"/>\n"
        f"              </g>\n"
        f"            </g>\n"
        f"            <g transform=\"translate(0,0),matrix(1 0 0 0.603015 0 0)\"/>\n"
        f"          </g>\n"
